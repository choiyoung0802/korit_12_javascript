...
myFunction2();
/**
 * 이상의 코드는 결과적으로 GET 요청 이후에 결과값을 가지고 PUT 요청을 새로 한 후에 PUT 의 결과를 확인할 수 있도록 GET 요청을 다시 날린 형태라고 볼 수 있습니다. 가독성이 떨어집니다.
 * 
...
async function myFunction3() {
  ...
  // 이상은 GET 요청 부분에 해당합니다. async / await 을 빼면 일반적인 JavaScript 처럼 함수 실행하고 결과값을 변수에 담는 것처럼 보입니다.
